      ...
      <div className="mx-auto max-w-7xl px-6 md:px-8">
        ...
        <div className="max-w-4xl">
          ...
          <p className="mt-8 text-xl leading-9 text-slate-600">
            A long-term research programme recovering the constitutional thought
            of Raja Ali Haji and demonstrating that the nineteenth-century Malay
            world generated its own sophisticated tradition of constitutional
        ...
        <div className="mt-20 grid gap-10 lg:grid-cols-2">
          ...
          <div className="rounded-3xl border border-slate-200 bg-slate-50 p-10">
            ...
            <p className="mt-5 text-lg leading-8 text-slate-600">
              ...
              <strong> Malay Ethical Constitutionalism </strong>
