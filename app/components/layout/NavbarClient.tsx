...
const groups = [
  ...
  { label: "Institutes", helper: "Lembaga, sistem & arsip", items: [["Raja Ali Haji Institute", "/raja-ali-haji"], ["AI & Digital Systems Lab", "/ai-lab"], ["Hukum Preneur", "/hukumpreneur"], ["Hizbul Wathan Kepri", "/hw-kepri"], ["Constitutional Justice", "/constitutional-justice"], ["Digital Archive", "/digital-archive"], ["Gallery", "/gallery"]] },
] as const;
