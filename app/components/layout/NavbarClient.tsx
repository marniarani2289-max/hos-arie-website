...
const groups = [
  ...
  { label: "Institutes", helper: "Lembaga & arsip", items: [["Raja Ali Haji Institute", "/raja-ali-haji"], ["Constitutional Justice", "/constitutional-justice"], ["Digital Archive", "/digital-archive"], ["Gallery", "/gallery"]] },
] as const;
