...
const purposes = [
  { id: "profile", title: "Mengenal Saya", en: "Profil akademik", text: "Kenali perjalanan akademik, kepakaran, dan rekam jejak Dr. Hos Arie Sibarani.", links: [["Profil akademik", "/id/about"]] },
  { id: "learn", title: "Belajar", en: "Kelas dan lokakarya", text: "Pilih program pembelajaran, ikuti workshop, atau belajar melalui video hukum.", links: [["Pendidikan Biru (Blue Education)", "/blue-education"], ["Pelatihan AI untuk guru & institusi", "/pelatihan-ai"], ["Bandingkan program", "/id#programmes"], ["Raja Ali Haji Institute", "/raja-ali-haji"], ["Workshop LexNusa", "/lexnusa/cohort"], ["Kelas Hukum Kejahatan Mayantara", "/lexnusa/mayantara"], ["Video Hukumpreneur", "https://www.youtube.com/hukumpreneur"]] },
  { id: "research", title: "Membaca Penelitian", en: "Riset dan publikasi", text: "Jelajahi penelitian, publikasi akademik, dan Journal of Malay Constitutional Studies.", links: [["Penelitian", "/id/research"], ["Publikasi", "/id/publications"], ["Jurnal JMCS", "/journal"]] },
  { id: "apps", title: "Menggunakan Aplikasi", en: "Aplikasi dan eksperimen", text: "Temukan alat untuk akreditasi sekolah, ruang kerja hukum, dan eksperimen AI.", links: [["SIMAKS · Akreditasi sekolah", "/simak"], ["LexNusa · Ruang kerja hukum", "/lexnusa"], ["AI Lab · Eksperimen", "/ai-lab"]] },
  { id: "collaborate", title: "Berkolaborasi", en: "Kemitraan", text: "Diskusikan penelitian bersama, undangan mengajar, workshop, atau kemitraan institusi.", links: [["Hubungi untuk kolaborasi", "/id/contact"]] },
] as const;
...
const englishPurposes = [
  ...
  { id: "learn", title: "Learn", en: "Courses & workshops", text: "Choose a learning programme, join a workshop, or explore legal education videos.", links: [["Blue Education · Kepulauan Riau", "/blue-education"], ["AI training for teachers & institutions", "/pelatihan-ai"], ["Compare programmes", "/#programmes"], ["Raja Ali Haji Institute", "/raja-ali-haji"], ["LexNusa Workshops", "/lexnusa/cohort"], ["Cybercrime Law Classroom", "/lexnusa/mayantara"], ["Hukumpreneur Videos", "https://www.youtube.com/hukumpreneur"]] },
