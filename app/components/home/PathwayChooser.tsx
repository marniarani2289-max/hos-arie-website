...
const purposes = [
  ...
  { id: "learn", title: "Belajar", en: "Learn", text: "Pilih program pembelajaran, ikuti workshop, atau belajar melalui video hukum.", links: [["Raja Ali Haji Institute", "/raja-ali-haji"], ["Workshop LexNusa", "/lexnusa/cohort"], ["Kelas Hukum Kejahatan Mayantara", "/lexnusa/mayantara"], ["Video Hukumpreneur", "https://www.youtube.com/hukumpreneur"]] },
...
const englishPurposes = [
  ...
  { id: "learn", title: "Learn", en: "Courses & workshops", text: "Choose a learning programme, join a workshop, or explore legal education videos.", links: [["Raja Ali Haji Institute", "/raja-ali-haji"], ["LexNusa Workshops", "/lexnusa/cohort"], ["Cybercrime Law Classroom", "/lexnusa/mayantara"], ["Hukumpreneur Videos", "https://www.youtube.com/hukumpreneur"]] },
