...
export default async function RahiPilotAdminPage() {
  ...
  return <main className="min-h-screen bg-[#f3f0e9] px-5 py-12 text-slate-950 sm:px-8"><div className="mx-auto max-w-[92rem]">
    ...
    <section className="mt-8 flex flex-wrap gap-3"><span className="rounded-full bg-emerald-100 px-4 py-2 font-bold text-emerald-900">Hijau {green}</span><span className="rounded-full bg-amber-100 px-4 py-2 font-bold text-amber-900">Kuning {yellow}</span><span className="rounded-full bg-red-100 px-4 py-2 font-bold text-red-900">Merah {red}</span><span className="ml-auto inline-flex items-center gap-2 text-sm font-bold text-slate-600"><Download size={17}/> Ekspor CSV disiapkan pada tahap laporan</span></section>
